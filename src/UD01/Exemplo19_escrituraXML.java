	...
	public class EjemploFicheroXMLDOMEscritura {
		...
		public static void main(final String[] args) throws IOException {
			...
			try {
				...
				Document documento = implementacion.createDocument(null, "Personas", null);// crea el documento con el
																							// nodo raíz de nombre
																							// Personas
				...
				// para mostrar el documento por pantalla, podemos especificar como resultado el
				// canal de salida System.out
