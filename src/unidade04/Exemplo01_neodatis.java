...
/* Programa que xestiona unha de datos NeoDatis que garda obxecto de tipo Empregado */
...
public class Exemplo01_neodatis {
	...
	public static void main(String[] args) {
		...
		Empleado empleado1 = new Empleado("Xan", "Príncipe, 32", null, 2500, 40);
		Empleado empleado2 = new Empleado("Begoña", "García Barbón, 80", "Vigo", 1800, 25);
		Empleado empleado3 = new Empleado("Luisa", "Principe de Vergara", null, 3200, 45);
		Empleado empleado4 = new Empleado("Asier", "Gran Vía, 102", "Bilbao", 2200, 38);
