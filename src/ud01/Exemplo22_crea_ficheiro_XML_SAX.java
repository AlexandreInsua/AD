...
public class Exemplo22_crea_ficheiro_XML_SAX {
	...
	flujo del documento y	* deteniéndose en cada nodo del camino.
*/
...
/*
* InputSource
* Esta clase permite una aplicación SAX para encapsular información acerca de una fuente de entrada
* en un solo objeto, que puede incluir un identificador público, un identificador de sistema,
* un flujo de bytes (posiblemente con una codificación especificada), y / o un flujo de caracteres.
